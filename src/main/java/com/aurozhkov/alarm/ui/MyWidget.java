...
public class MyWidget extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(intent.getAction() != null && intent.getAction().equalsIgnoreCase(ACTION_CHANGE)) {
            ...
            if(mAppWidgetId != AppWidgetManager.INVALID_APPWIDGET_ID) {
                ...
                AlarmStorageUtils.setAlarmOn(context, !on);
    ...
    private static void updateTime(RemoteViews widgetView, Context context) {
        ...
        widgetView.setTextViewText(R.id.time, alarmTime.toString());
    }
    ...
    private static PendingIntent getOnOffIntent(Context context, int widgetID) {
        Intent onOffIntent = new Intent(context, MyWidget.class);
